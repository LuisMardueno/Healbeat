...
namespace ProSalud
{
    public partial class AdmResultados : Form
    {
        ...
        private void AdmResultados_Load(object sender, EventArgs e)
        {
            ...
            conexion.Open();
            //Datos del tecnico
            SqlCommand coman = new SqlCommand($"SELECT * FROM users where user=@Usuario", conexion);
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            //Datos usuario
            SqlCommand comando2 = new SqlCommand($"SELECT * FROM users where nombre=@Nombre", conexion);
