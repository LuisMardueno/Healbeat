...
namespace ProSalud
{
    public partial class AdmTomografia : Form
    {
        public AdmTomografia()
        {
            InitializeComponent();
        }
        ...
        public void llenar_grid()
        {
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter("Select * from Tomografia", conexion);
                //Tabla en memoria
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand altas = new SqlCommand("insert into Tomografia(Estudio, Precio, Descripcion) values( @Estudio, @Precio, @Descripcion)", conexion);
            ...
            SqlCommand comando = new SqlCommand("SELECT ID FROM Tomografia", conexion);
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            // Comando para insertar datos
            SqlCommand comando = new SqlCommand("update Tomografia set Estudio=@Estudio, Precio=@Precio, Descripcion=@Descripcion where Id=@ID", conexion);
            // Enviar parametro
        ...
        private void btnElimiar_Click(object sender, EventArgs e)
        {
            ...
            string baja = "Delete From Tomografia Where Id=@ID";
        ...
        private void AdmTomografia_Load(object sender, EventArgs e)
        {
            // Abrir conexion
            conexion.Open();

            // Cargar las Id de Usuarios en el combobox
            SqlCommand comando = new SqlCommand("SELECT ID FROM RayosX", conexion);
        ...
        private void cmbId_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand comando = new SqlCommand($"SELECT *FROM Tomografia where Id=@ID", conexion);
            // Enviar id
            comando.Parameters.AddWithValue("Id", cmbId.SelectedItem);
