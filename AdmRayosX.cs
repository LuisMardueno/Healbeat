...
namespace ProSalud
{
    public partial class AdmRayosX : Form
    {
        public AdmRayosX()
        {
            InitializeComponent();
        ...
        public void llenar_grid()
        {
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter("Select * from RayosX", conexion);
                //Tabla en memoria
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand altas = new SqlCommand("insert into RayosX(Estudio, Precio, Descripcion) values( @Estudio, @Precio, @Descripcion)", conexion);
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            // Comando para insertar datos
            SqlCommand comando = new SqlCommand("update RayosX set Estudio=@Estudio, Precio=@Precio, Descripcion=@Descripcion where Id=@ID", conexion);
            // Enviar parametro
        ...
        private void btnElimiar_Click(object sender, EventArgs e)
        {
            ...
            string baja = "Delete From RayosX Where Id=@ID";
        ...
        private void AdmRayosX_Load(object sender, EventArgs e)
        {
            // Abrir conexion
            conexion.Open();
        ...
        private void cmbId_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand comando = new SqlCommand($"SELECT *FROM RayosX where Id=@ID", conexion);
            // Enviar id
            comando.Parameters.AddWithValue("Id", cmbId.SelectedItem);
