...
namespace ProSalud
{
    public partial class Electrocardiograma : Form
    {
        // Conexion con SQL
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            while (reader.Read())
            {
                ...
                DateTime a = Convert.ToDateTime(reader[3].ToString());
            ...
            altas.Parameters.AddWithValue("Estudio", "Electrocardiograma");
        ...
        private void Electrocardiograma_Load(object sender, EventArgs e)
        {
            // Cargar los nombres de peliculas en el combobox
            conexion.Open();
            SqlCommand comando = new SqlCommand("SELECT Estudio FROM Electro", conexion);
        ...
        private void cmbEstudio_SelectedIndexChanged(object sender, EventArgs e)
        {
                ...
                SqlCommand comando = new SqlCommand($"SELECT *FROM Electro where Estudio=@Estudio", conexion);
                // Proporcionar nombre
