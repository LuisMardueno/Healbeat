...
namespace ProSalud
{
    public partial class RayosX : Form
    {
        // Conexion con SQL
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            altas.Parameters.AddWithValue("Estudio", "Rayos X");
        ...
        private void cmbHora_Click(object sender, EventArgs e)
        {
            cmbEstudio.Enabled = true;
        }

        private void RayosX_Load(object sender, EventArgs e)
        {
            // Cargar los nombres de peliculas en el combobox
            conexion.Open();
            SqlCommand comando = new SqlCommand("SELECT Estudio FROM RayosX", conexion);
        ...
        private void cmbEstudio_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand comando = new SqlCommand($"SELECT *FROM RayosX where Estudio=@Estudio", conexion);
            // Proporcionar nombre
