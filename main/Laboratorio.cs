    ...
    public partial class Laboratorio : Form
    {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
           ...
           SqlCommand altas = new SqlCommand("insert into Cita(Sucursal, Municipio, Estado, Fecha, Hora, Estudio, Tipo, Precio, Codigo, Usuario) values(@Sucursal, @Municipio, @Estado, @Fecha, @Hora, @Estudio, @Tipo, @Precio, @Codigo, @Usuario)", conexion);
            ...
            altas.Parameters.AddWithValue("Estudio", "Laboratorio");
        ...
        private void Laboratorio_Load(object sender, EventArgs e)
        {
            ...
            conexion.Open();
            SqlCommand comando = new SqlCommand("SELECT Estudio FROM Laboratorio", conexion);
        ...
        private void cmbEstudio_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand comando = new SqlCommand($"SELECT *FROM Laboratorio where Estudio=@Estudio", conexion);
            // Proporcionar nombre
