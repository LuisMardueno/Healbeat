...
namespace ProSalud
{
    public partial class AdmResonancia : Form
    {
        public AdmResonancia()
        {
            InitializeComponent();
        }
        // Conexion con SQL
        ...
        public void llenar_grid()
        {
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter("Select * from Resonancia", conexion);
                //Tabla en memoria
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand altas = new SqlCommand("insert into Resonancia(Estudio, Precio, Descripcion) values( @Estudio, @Precio, @Descripcion)", conexion);
            ...
            SqlCommand comando = new SqlCommand("SELECT ID FROM Resonancia", conexion);
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            // Comando para insertar datos
            SqlCommand comando = new SqlCommand("update Resonancia set Estudio=@Estudio, Precio=@Precio, Descripcion=@Descripcion where Id=@ID", conexion);
            // Enviar parametro
        ...
        private void btnElimiar_Click(object sender, EventArgs e)
        {
            ...
            string baja = "Delete From Resonancia Where Id=@ID";
        ...
        private void AdmResonancia_Load(object sender, EventArgs e)
        {
            // Abrir conexion
            conexion.Open();
        ...
        private void cmbId_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand comando = new SqlCommand($"SELECT *FROM Resonancia where Id=@ID", conexion);
            // Enviar id
            comando.Parameters.AddWithValue("Id", cmbId.SelectedItem);
