...
namespace ProSalud
{
    public partial class AdmLaboratorio : Form
    {
        ...
        public void llenar_grid()
        {
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter("Select * from Laboratorio", conexion);
                //Tabla en memoria
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand altas = new SqlCommand("insert into Laboratorio(Estudio, Precio, Descripcion) values( @Estudio, @Precio, @Descripcion)", conexion);
            ...
            SqlCommand comando = new SqlCommand("SELECT ID FROM Laboratorio", conexion);
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            // Comando para insertar datos
            SqlCommand comando = new SqlCommand("update Laboratorio set Estudio=@Estudio, Precio=@Precio, Descripcion=@Descripcion where Id=@ID", conexion);
            // Enviar parametro
        ...
        private void btnElimiar_Click(object sender, EventArgs e)
        {
            ...
            string baja = "Delete From Laboratorio Where Id=@ID";
        ...
        private void AdmLaboratorio_Load(object sender, EventArgs e)
        {
            // Abrir conexion
            conexion.Open();
        ...
        private void cmbId_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand comando = new SqlCommand($"SELECT *FROM Laboratorio where Id=@ID", conexion);
            // Enviar id
            comando.Parameters.AddWithValue("Id", cmbId.SelectedItem);
