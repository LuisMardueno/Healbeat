...
namespace ProSalud
{
    public partial class Resonancia : Form
    {
        // Conexion con SQL
        ...
        public Resonancia()
        {
            ...
            MessageBox.Show("Precausiones:Evitar acudir con tarjetas de crédito, \n"
                          + "sortijas, objetos metálicos y/o de valor, marcapasos \n"
                          + "cardiaco. Es recomendable acudir con un acompañante. \n "
                          + "Acudir con ropa comoda. Límite de peso 120 Kg.", "Importante", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            altas.Parameters.AddWithValue("Estudio", "Resonancia Magnética");
        ...
        private void Resonancia_Load(object sender, EventArgs e)
        {
            // Cargar los nombres de peliculas en el combobox
            conexion.Open();
            SqlCommand comando = new SqlCommand("SELECT Estudio FROM Resonancia", conexion);
        ...
        private void cmbEstudio_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand comando = new SqlCommand($"SELECT *FROM Resonancia where Estudio=@Estudio", conexion);
            // Proporcionar nombre
