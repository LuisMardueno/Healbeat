...
namespace ProSalud
{
    public partial class Tomografia : Form
    {
        ...
        public Tomografia()
        {
            ...
            MessageBox.Show("Precausiones:Evitar acudir con sortijas, objetos\n"
                          + "metálicos y/o de valor. Es recomendable acudir con\n "
                          + "un acompañante. Acudir con ropa comoda.Límite de \n" 
                          + "peso 120 Kg.", "Importante", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            altas.Parameters.AddWithValue("Estudio", "Tomografía");
        ...
        private void Tomografia_Load(object sender, EventArgs e)
        {
            ...
            conexion.Open();
            SqlCommand comando = new SqlCommand("SELECT Estudio FROM Tomografia", conexion);
        ...
        private void cmbEstudio_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand comando = new SqlCommand($"SELECT *FROM Tomografia where Estudio=@Estudio", conexion);
            // Proporcionar nombre
